...
const Akt2 = () => {
    ...
    },
    {
      ...
      dzwiek: "/Hamlet/txt8.mp3"
    },
    {
      obraz: "/Hamlet/page1.png",
      tekst1: "",
      tekst2: "",
      dzwiek: "/Hamlet/txt9.mp3"
    }

  ];
  return (
    <div id='Akt II' style={{background: "url('/Hamlet/tlo3.jpg')", backgroundSize: "cover", backgroundPosition: "center"}} className='w-full flex justify-center items-center h-full inset-0 hide absolute animate-pojawianie delay-0 opacity-0 overflow-hidden'>
    ...
    <img src="/Hamlet/hamlet1.png" className='object-cover absolute object-center w-full' alt="" />
    <img src="/Hamlet/hamlet3.png" className='object-cover animate-mruga absolute object-center w-full' alt="" />
    <img src="/Hamlet/hamlet2.png" className='object-cover animate-reka absolute object-center w-full origin-[41%_63%]' alt="" />
