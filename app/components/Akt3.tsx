...
const Akt3 = () => {
  ...
  return (
    <div id='Akt III' style={{background: "url('stage.jpg')", backgroundSize: "cover", backgroundPosition: "center"}} className='w-full flex justify-center items-center h-full inset-0 hide absolute animate-pojawianie delay-0 opacity-0 overflow-hidden'>
      ...
      <div onClick={dym} className='z-1 absolute left-[-2%] bottom-0 opacity-0 cursor-pointer animate-pojawianie delay-1000' style={{width: "min(72vw, 54vh)", aspectRatio: "4/3"}}>
        <img src="hamlet6.png" className='absolute sharpn inset-0 w-full h-full object-cover' alt="" />
        <img src="hamlet.gif" className='absolute inset-0 w-full h-full object-cover' style={{opacity: mowi ? 1 : 0}} alt="" />
      </div>
      <Powrot id="Akt III"/>
      <audio className='cytat' src="c1.mp3"></audio>
      <audio className='cytat' src="c2.mp3"></audio>
      <audio className='cytat' src="c3.mp3"></audio>
      <audio className='cytat' src="c4.mp3"></audio>
      <audio className='cytat' src="c5.mp3"></audio>
      <audio className='cytat' src="c6.mp3"></audio>
      <audio className='cytat' src="c7.mp3"></audio>
      <audio className='cytat' src="c8.mp3"></audio>
      <audio className='cytat' src="c9.mp3"></audio>
      <audio className='cytat' src="c10.mp3"></audio>
      <audio className='cytat' src="c11.mp3"></audio>
    </div>
  )
}
